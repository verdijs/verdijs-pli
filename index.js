...
var PLI = {
  ...
  src: {
    ...
    test: {
      ...
      typescript: './src/test/typescript'
    }
  },
  target: {
    main: {
      ...
      typescript: './target/main/typescript'
    },
    test: {
      js: './target/test/js/',
      css: './target/test/css/',
      ...
      typescript: './target/test/typescript'
    }
  },
  deploy: {
    main: {
      ...
      typescript: './deploy/main/typescript'
    },
    test: {
      js: './deploy/test/js/',
      css: './deploy/test/css/',
      ...
      typescript: './deploy/test/typescript'
    }
  }
}
